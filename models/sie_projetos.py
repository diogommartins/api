...
dbSie.define_table("PROJETOS",
                   ...
                   # Field("VL_BOLSA", "float"),e
                   Field("ID_BOLSA", "integer"),
                   Field("PALAVRA_CHAVE01", "string", length=25),
                   Field("PALAVRA_CHAVE02", "string", length=25),
                   Field("PALAVRA_CHAVE03", "string", length=25),
                   Field("PALAVRA_CHAVE04", "string", length=25),
