# coding=utf-8
from procedures.inscricao_candidatos.schema import InscricaoCandidatoPosGraduacaoSchema
...
class InscricaoCandidatoPosGraduacao(BaseSIEProcedure):
    ...
    def schema(self):
        ...
        schema = InscricaoCandidatoPosGraduacaoSchema.schema
...
dataset = {}
output = procedure.perform_work(dataset, commit=False)